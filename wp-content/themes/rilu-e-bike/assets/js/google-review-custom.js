jQuery(document).ready(function () {
  ...
  //         jQuery("#" + id + " .review-item-long1").show();
    
  //         jQuery("#" + id + " .review-item-short1").hide();
  //       }
  //   else
  //       {
  //         var id = jQuery(this).data("id");
  ...
  //         jQuery("#" + id + " .review-item-long1").hide();
    
  //         jQuery("#" + id + " .review-item-short1").show();
  //       }
  //   });
